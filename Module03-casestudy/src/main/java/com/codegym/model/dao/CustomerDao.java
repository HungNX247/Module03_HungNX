...
import com.codegym.connection.JbdcConnection;
...
public class CustomerDao {
    ...
    public List<Customer> getAll() {
        ...
        try {
            ...
            while(resultSet.next()) {
                ...
                customer.setStart_date(resultSet.getDate("start_date"));
    ...
    public void insert(Customer customer) {
        try {
            ...
            Connection connection = JbdcConnection.getConnection();
            String query = "INSERT INTO customers(name, position, office, age, start_date, salary) VALUES(?, ?, ?, ?, ?, ?)";
            PreparedStatement preparedStatement = connection.prepareStatement(query);
            preparedStatement.setString(1, customer.getName());
            preparedStatement.setString(2, customer.getPosition());
            preparedStatement.setString(3, customer.getOffice());
            preparedStatement.setInt(4, customer.getAge());
            Date utilStartDate = customer.getStart_date();
    ...
    public void update(Customer customer) {
        try {
            Connection connection = JbdcConnection.getConnection();
            String query = "UPDATE customers SET name = ?, position = ?, office = ?, age = ?, start_date = ?, salary = ? WHERE id = ?;";
            PreparedStatement preparedStatement = connection.prepareStatement(query);
            preparedStatement.setString(1, customer.getName());
            preparedStatement.setString(2, customer.getPosition());
            preparedStatement.setString(3, customer.getOffice());
