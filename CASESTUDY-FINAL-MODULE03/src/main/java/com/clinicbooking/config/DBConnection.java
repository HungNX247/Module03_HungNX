package com.clinicbooking.config;
...
public class DBConnection {
    ...
    private static final String CONN_URL = "jdbc:mysql://localhost:3306/clinic_booking?useSSL=false&serverTimezone=Asia/Ho_Chi_Minh";
